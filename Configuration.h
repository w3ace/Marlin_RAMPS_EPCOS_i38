...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4032,103}  // default steps prevent unit for ultimaker {78.7402,78.7402,200*8/3,760*1.1}920
#define DEFAULT_MAX_FEEDRATE          {250, 250, 2, 22}    // (mm/sec)    
#define DEFAULT_MAX_ACCELERATION      {500,500,5,1000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
